...
// User-level .qwen directory in home
const USER_QWEN_DIR = path.join(os.homedir(), '.qwen');
...
export const OTEL_DIR = path.join(USER_QWEN_DIR, 'tmp', projectHash, 'otel');
export const BIN_DIR = path.join(OTEL_DIR, 'bin');

// Workspace settings remain in the project's .qwen directory
