...
interface MockServerConfig {
  ...
  getQwenMdFileCount: Mock<() => number>;
  setQwenMdFileCount: Mock<(count: number) => void>;
...
// Mock @qwen/qwen-cli-core and its Config class
vi.mock('@qwen/qwen-cli-core', async (importOriginal) => {
  const actualCore =
    await importOriginal<typeof import('@qwen/qwen-cli-core')>();
  const ConfigClassMock = vi
    ...
    .mockImplementation((optionsPassedToConstructor) => {
      ...
      return {
        ...
        setUserMemory: vi.fn(),
        getQwenMdFileCount: vi.fn(() => opts.qwenMdFileCount || 0),
        setQwenMdFileCount: vi.fn(),
...
describe('App UI', () => {
  ...
  it('should display default "GEMINI.md" in footer when contextFileName is not set and count is 1', async () => {
    mockConfig.getQwenMdFileCount.mockReturnValue(1);
  ...
  it('should display default "GEMINI.md" with plural when contextFileName is not set and count is > 1', async () => {
    mockConfig.getQwenMdFileCount.mockReturnValue(2);
    mockConfig.getDebugMode.mockReturnValue(false);
    mockConfig.getShowMemoryUsage.mockReturnValue(false);
  ...
  it('should display custom contextFileName with plural when set and count is > 1', async () => {
    ...
    mockConfig.getQwenMdFileCount.mockReturnValue(3);
    mockConfig.getDebugMode.mockReturnValue(false);
    mockConfig.getShowMemoryUsage.mockReturnValue(false);
  ...
  it('should not display context file message if count is 0, even if contextFileName is set', async () => {
    ...
    mockConfig.getQwenMdFileCount.mockReturnValue(0);
    mockConfig.getDebugMode.mockReturnValue(false);
    mockConfig.getShowMemoryUsage.mockReturnValue(false);
