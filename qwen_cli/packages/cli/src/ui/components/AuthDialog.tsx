...
export function AuthDialog({
  ...
  const items = [
    { label: 'Qwen/DashScope API Key', value: AuthType.USE_QWEN_DASHSCOPE },
  ];
  ...
  return (
    ...
    >
      ...
      <Box marginTop={1}>
        <Text>Terms of Services and Privacy Notice for Qwen CLI</Text>
      </Box>
      <Box marginTop={1}>
        <Text color={Colors.AccentBlue}>
          {
            'https://help.aliyun.com/zh/dashscope/developer-reference/terms-of-service'
          }
        </Text>
      </Box>
    </Box>
