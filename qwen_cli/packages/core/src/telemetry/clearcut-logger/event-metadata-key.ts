...
export enum EventMetadataKey {
  ...
  QWEN_CLI_USER_PROMPT_LENGTH = 13,
  ...
  // Logs the model id of the API call.
  QWEN_CLI_API_ERROR_MODEL = 30,

  // Logs the error type.
  QWEN_CLI_API_ERROR_TYPE = 31,

  // Logs the status code of the error response.
  QWEN_CLI_API_ERROR_STATUS_CODE = 32,

  // Logs the duration of the API call in milliseconds.
  QWEN_CLI_API_ERROR_DURATION_MS = 33,
