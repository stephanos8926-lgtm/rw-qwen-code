...
let mockQwenClientInstance: Mocked<QwenClient>;
...
const mockConfigInternal = {
  ...
  getQwenClient: vi.fn(), // Initialize as a plain mock function
  getApiKey: () => 'test-key',
  getModel: () => 'test-model',
  getSandbox: () => false,
  getDebugMode: () => false,
...
describe('WriteFileTool', () => {
  ...
  beforeEach(() => {
    ...
    mockQwenClientInstance = new (vi.mocked(QwenClient))(
      mockConfig,
    ) as Mocked<QwenClient>;
    vi.mocked(QwenClient).mockImplementation(() => mockQwenClientInstance);

    // Now that mockQwenClientInstance is initialized, set the mock implementation for getQwenClient
    mockConfigInternal.getQwenClient.mockReturnValue(
      mockQwenClientInstance,
    );
